#!/usr/bin/env python3
"""
BAYS Soccer Analysis - All 8 Core Metrics
Complete rankings for all towns
"""
...
print("=" * 80)
print("BAYS SOCCER - 8 CORE METRICS ANALYSIS")
print("=" * 80)
print()
...
# Calculate all 8 metrics for all towns
all_metrics = {}
...
# Print ranking table
print("Town          M1  M2  M3  M4  M5  M6  M7  M8  Avg  Top-3")
print("-" * 65)
for town in sorted(towns, key=lambda t: rank_summary[t]['avg_rank']):
    ...
    print(f"{town_names[town]:13s} {ranks[0]}   {ranks[1]}   {ranks[2]}   {ranks[3]}   {ranks[4]}   {ranks[5]}   {ranks[6]}   {ranks[7]}   {avg:.1f}   {top3}/8")
...
print(f"  Top-3 Finishes: {rank_summary[best_overall]['top3_count']}/8 metrics")
...
print(f"  Top-3 Finishes: {rank_summary[worst_overall]['top3_count']}/8 metrics")
...
print("\n" + "=" * 80)
print("Analysis Complete - All 8 Core Metrics")
print("=" * 80)
